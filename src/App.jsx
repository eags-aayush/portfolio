    ...
    <>
      ...
      <div name='Projetcs made' className={`flex flex-col gap-3 bg-primary p-5 rounded-xl mb-5`}>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          <Project title='Mittika' desc='Mittika is a handcrafted home decor showcase website designed for a small artisan brand focused on natural, earthy products. Built as a lightweight and elegant platform, Mittika allows visitors to explore a curated collection of handmade vases, lamps, and wall art. With a warm, minimalistic design, smooth navigation, and mobile-friendly layout, the site emphasizes simplicity and beauty. Visitors can view detailed product pages and effortlessly send inquiries through an integrated contact form — no logins or payments needed. Mittika bridges artisanship and digital presence, helping local craft reach modern audiences.' projectLink='https://mittika.netlify.app/' language={<Language language={['html5', 'css', 'JavaScript', 'TailwindCSS', 'React']} />} />
